-- Recreate referral-based mining boost system
-- This ensures the compute_boosted_mining_rate function exists in the database
-- Formula: mining_rate = base_rate * (1 + (referral_count * 0.10))

-- Drop existing functions if they exist
DROP FUNCTION IF EXISTS get_user_referral_count(UUID);
...
COMMENT ON FUNCTION compute_boosted_mining_rate IS 'Computes mining rate with 10% boost per referral. Returns base_rate, referral_count, boost_percentage, and final_rate.';
